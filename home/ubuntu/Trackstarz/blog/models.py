...
class Reply(models.Model):
    ...
    author = models.ForeignKey(userprofile, on_delete=models.CASCADE)
    from_user = models.ForeignKey(userprofile, related_name='reply_from_user', on_delete=models.CASCADE, null=True, blank=True)
    timestamp  = models.DateTimeField(auto_now_add=True)
    content = models.TextField()
...
class BurstLike(models.Model):
    ...
    author = models.ForeignKey(userprofile, related_name='burstlikers', on_delete=models.CASCADE)
...
class CommentLike(models.Model):
    ...
    author = models.ForeignKey(userprofile, related_name='commentlikers', on_delete=models.CASCADE)
...
class ReplyLike(models.Model):
    ...
    author = models.ForeignKey(userprofile, related_name='replylikers', on_delete=models.CASCADE)
